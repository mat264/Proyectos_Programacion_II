...
// Llena aleatoriamente una matriz con letras de un segundo nombre.
// Si una posición ya tiene letra, se marca con '*'. Se visualiza paso a paso.
...
public class g3_Array5 {
    ...
    // Imprime la matriz en pantalla; usa '.' para posiciones vacías
    ...
    // Llena la matriz con letras aleatorias tomadas de nombreLetras (for)
