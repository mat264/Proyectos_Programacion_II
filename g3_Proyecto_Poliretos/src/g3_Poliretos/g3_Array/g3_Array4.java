...
// Construye una matriz n x n con los caracteres del nombre ingresado en las diagonales
// (crea una X con el nombre). Tiene versiones for/while/do-while.

public class g3_Array4 {

    // Lee el nombre completo y dibuja la X con for
