...
// Mueve un carácter del nombre por la pantalla (simula movimiento con limpieza de pantalla).
// Útil para ver control de pantalla y posición; incluye ejemplos con for/while/do-while.

public class g3_Loading9 {

    // Retardo mayor para animación más lenta
    private void delay() {
        try { Thread.sleep(100); } catch (InterruptedException e) {}
    }
    
    // Limpia la pantalla (ANSI) para simular movimiento
    private void clearScreen() {
        System.out.print("\033[H\033[2J");
        System.out.flush();
    }

    // Mueve una letra del nombre a la derecha usando for
