...
// Barra de progreso con un caracter que se mueve a través de la barra (efecto "cursor").
// Implementado con for, while y do-while.
...
public class g3_Loading3 {
    ...
    // Pide un caracter y muestra el cursor moviéndose usando for
